...
from app.pages import index, inbound_page, outbound_page, move_page, inventory_page, history_page, calendar_month_page, admin_page, mobile_home, korean_redirects, qr_page
